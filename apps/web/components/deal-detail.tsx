    ...
    <main className="min-h-screen">
      ...
      <section className="mx-auto grid max-w-7xl gap-6 px-6 py-6 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="space-y-6">
                ...
                <div className="border-l-2 border-line pl-4" key={activity.id}>
                  ...
                  <div className="mt-3 grid gap-3 md:grid-cols-2">
                    ...
                    <div className="rounded-md border border-line bg-white p-3">
                      <p className="text-xs font-semibold uppercase text-zinc-500">AI Interpretation</p>
                      <p className="mt-2 text-sm leading-6 text-zinc-700">
                        {latestInsight?.interpretation ?? 'Run analysis to generate an interpretation.'}
                      </p>
                    </div>
                  </div>
                </div>
          ...
          {latestInsight && (
            <div className="rounded-md border border-line bg-white p-5">
              <h2 className="text-base font-semibold text-ink">Latest Activity Summary</h2>
