...
import { BarChart3, Bot, BriefcaseBusiness, LayoutDashboard, Settings } from "lucide-react";
...
export function AppShell({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen">
      <aside className="fixed inset-y-0 left-0 z-40 hidden w-64 border-r bg-background/82 px-4 py-5 backdrop-blur-xl lg:block">
